...
```{python}
df = pd.read_csv('/Users/cherisa/Documents/ND/Fall/Unstructured Data Analytics/final_project/final_files/ts_tw_lyrics1.csv')
...
```{python}
df1 = pd.read_csv('/Users/cherisa/Documents/ND/Fall/Unstructured Data Analytics/final_project/final_files/albums.csv')
...
```{python}
df1['album_name'] = df1['album_name'].str.replace(r'^Taylor Swift\s*[–]\s', '', regex=True).str.strip()
df1
```
...
```{python}
final_result.to_csv('/Users/cherisa/Documents/ND/Fall/Unstructured Data Analytics/final_project/final_dataset.csv', index=False)
```